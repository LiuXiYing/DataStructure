...
| :--- | :--- | :--- | :--- |
| `p` 的地址 | 0xb01840 | 0xb01840 | 0xb01740 |
| `p->data` | 25 | 25 | 18 |
| `p->next` 的地址 | 0xb01740| 0xb01740 | 0xb01780|
| `prev->next` 的地址（图 C 填 `list->head->next`） | 0xb01740| 0xb01840 | 0xb01780 |
| `list->size` | 5 | 6 | 5 |
