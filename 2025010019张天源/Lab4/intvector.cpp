...
int main() {
    IntVector v;
    std::cout << "空表: size = " << v.getSize() << ", empty = " << v.empty()
              << std::endl;
    ...
    std::cout << "remove(1) 返回 " << ok << ", 删除的值是 " << removed
              << std::endl;
    v.print();
    ...
    std::cout << "最终: size = " << v.getSize() << ", empty = " << v.empty()
              << std::endl;
    ...
    std::cout << "other: ";
    other.print();
    std::cout << "两个对象的 size: " << v.getSize() << " " << other.getSize()
              << std::endl;

    return 0;
}//
// Created by full2 on 2026/9/13.
//
